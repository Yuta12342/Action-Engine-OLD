...
class WeekEditorState extends MusicBeatState
{
	...
	var linkCheckbox:FlxUICheckBox;
	...
	function addWeekUI() {
		...
		linkCheckbox = new FlxUICheckBox(hideCheckbox.x + 120, weekFileInputText.y + 40, null, null, "Linked Week?", 100);
		linkCheckbox.callback = function()
		{
			weekFile.linkWeek = linkCheckbox.checked;
		};
	...
	function reloadAllShit() {
		...
		linkCheckbox.checked = weekFile.linkWeek;
