...
class StageEditorState extends MusicBeatState
{
	...
	public function new(daAnim:String = 'stage', goToPlayState:Bool = true)
	{
		super();
		this.daAnim = daAnim;
	...
	function addAnimationsUI() {
		var tab_group = new FlxUI(null, UI_box);
		tab_group.name = "Static Sprites";

		var spriteTag = new FlxUIInputText(15, 85, 80, '', 8);
		var imagePath = new FlxUIInputText(15, spriteTag.y + 35, 80, 'Image Path', 8);
		//animationNameInputText = new FlxUIInputText(animationInputText.x, animationInputText.y + 35, 150, '', 8);
		//animationIndicesInputText = new FlxUIInputText(animationNameInputText.x, animationNameInputText.y + 40, 250, '', 8);
		var overlapCharsCheckbox = new FlxUICheckBox(imagePath.x + 170, imagePath.y - 1, null, null, "Overlap Characters", 100);
	...
	function reloadCharacterDropDown() {
		...
		#else
		characterList = CoolUtil.coolTextFile(Paths.txt('stageList'));
		#end
	...
	function updatePresence() {
		...
		DiscordClient.changePresence("Stage Editor", "Stage: " + daAnim, leHealthIcon.getCharacter());
		#end
	}
