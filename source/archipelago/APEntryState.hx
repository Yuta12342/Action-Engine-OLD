...
var	allow_just_as_planned_dlc_songs:Bool;
var	streamer_mode_enabled:Bool;
var	starting_song_count:Int;
var	additional_song_count:Int;
var	additional_item_percentage:Int;
var	grade_needed:String;
var	available_trap_types:Array<String>;
var	trap_count_percentage:Int;
var	death_link:Bool;
var	include_songs:Array<String>;
var	exclude_songs:Array<String>;
...
class APEntryState extends FlxState
{
	...
	function onGenYaml()
	{
	var gameSettings:APSettings = {
			progression_balancing: "random",
			accessibility: "items",
			allow_just_as_planned_dlc_songs: true,
			streamer_mode_enabled: false,
			starting_song_count: 0,
			additional_song_count: 0,
			additional_item_percentage: 0,
			grade_needed: "random",
			available_trap_types: ["random"],
			trap_count_percentage: 0,
			death_link: true,
			include_songs: [],
			exclude_songs: [],
